...
interface PersistentDataStore<in L> {
     ...
     */
    fun <T : Any> get(dataKey: PersistentDataKey<T>, locationKey: L): T?
     ...
     */
    fun <T : Any> set(dataKey: PersistentDataKey<T>, locationKey: L, value: T?)
